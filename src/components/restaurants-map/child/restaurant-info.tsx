            ...
            {!detailsClicked &&
                <div>
                    ...
                    <div style={{display: 'flex', justifyContent: 'space-between', fontSize: '0.7rem'}}>
                        ...
                        <div>{restaurant.startTime} - {restaurant.endTime}</div>                        
                    </div>
                    <div style={{display: 'flex', justifyContent: 'space-between', fontSize: '0.7rem', width: '100%'}}>
                        <div style={{width: '70%'}}>Happy Hour</div>
                        <div style={{textAlign: 'right'}}>{restaurant.happyhourHour}</div>                        
                    </div>                    
                    <Buttons>
                        ...
                        <TextBtn onClick={handleDetailsBtnClick}>Menus</TextBtn>
                    </Buttons>
                </div>
            }
            {detailsClicked && 
